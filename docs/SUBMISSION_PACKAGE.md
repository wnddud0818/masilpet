...
2. 체크인 보상은 알 부화, 펫 성장, 도감 수집률, 탐험 준비 상태로 이어집니다.
...
2. 지도 탭에서 현재 위치를 확인하고 주변 POI를 조회합니다.
3. 150m 안의 장소에 체크인해 펫 성장치와 알 진행도를 받습니다.
4. 마실펫 탭에서 대표 펫과 대화하거나 먹이를 줍니다.
5. 하우스와 도감에서 성장 상태, 보유 펫, 수집률을 확인합니다.
6. 내 정보 탭에서 실행 모드, 개인정보 처리방침, 진행도 동기화 상태를 확인합니다.
