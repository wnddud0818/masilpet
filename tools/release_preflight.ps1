...
Test-RequiredFile "build/web/robots.txt"
Test-RequiredFile "build/web/icons/Icon-192.png"
Test-RequiredFile "build/web/icons/Icon-512.png"
Test-RequiredFile "build/web/icons/Icon-maskable-192.png"
Test-RequiredFile "build/web/icons/Icon-maskable-512.png"
Test-RequiredFile "build/web/screenshots/onboarding-wide.png"
Test-RequiredFile "build/web/screenshots/onboarding-mobile.png"
